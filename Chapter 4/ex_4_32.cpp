#include "union_find_multi_array.h"
#include <iostream>
#include<time.h>

void test_union_find_2() {
	int num_links = 10;
	...
	std::cout << info.return_num_nodes(2) << std::endl;

}

void test_union_find_path_compression_2() {
	int num_links = 10;
	int* p = new int[num_links];
	int* q = new int[num_links];
...
int main_4_32() {
	test_union_find_2();
	std::cout << "------------------------" << std::endl;
	test_union_find_path_compression_2();
	return 0;
}